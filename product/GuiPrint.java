...
public class GuiPrint extends JFrame
{
    ...
    public GuiPrint(final String[][] data) {
        this.initComponents();
        this.jTable1.setUI(new BasicTableUI());
    ...
    private void initComponents() {
        ...
        this.jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt) {
                GuiPrint.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.header.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                GuiPrint.this.headerActionPerformed(evt);
            }
        });
        ...
        this.ShowPrintPage.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                GuiPrint.this.ShowPrintPageActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jScrollPane1, -1, 405, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jPanel1, -2, -1, -2).addGap(0, 0, 0)));
        this.pack();
    }
    ...
    public static void main(final String[] args) {
        try {
            ...
            Logger.getLogger(GuiPrint.class.getName()).log(Level.SEVERE, null, ex2);
        }
        catch (IllegalAccessException ex3) {
            Logger.getLogger(GuiPrint.class.getName()).log(Level.SEVERE, null, ex3);
        }
        catch (UnsupportedLookAndFeelException ex4) {
            Logger.getLogger(GuiPrint.class.getName()).log(Level.SEVERE, null, ex4);
        }
        EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new GuiPrint(new String[][] { { "test", "test", "test", "test", "test" } }).setVisible(true);
            }
        });
    }
